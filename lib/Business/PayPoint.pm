...
sub repeatCardFullAddr {
    ...
    my $ordered_keys = ['trans_id', 'amount', 'remote_pswd', 'new_trans_id', 'exp_date', 'order', 'bill', 'ship', 'options'];
...
sub repeatCardFull {
    ...
    my $ordered_keys = ['trans_id', 'amount', 'remote_pswd', 'new_trans_id', 'exp_date', 'order'];
...
sub getReport {
    ...
    my $ordered_keys = ['remote_pswd', 'report_type', 'cond_type', 'condition', 'currency', 'predicate', 'html', 'showErrs'];
...
sub getTZReport {
    ...
    my $ordered_keys = ['remote_pswd', 'report_type', 'cond_type', 'condition', 'currency', 'predicate', 'html', 'showErrs', 'tz'];
...
sub threeDSecureEnrolmentRequest {
    ...
    my $ordered_keys = ['trans_id', 'ip', 'name', 'card_number', 'amount', 'expiry_date', 'issue_number', 'start_date', 'order', 'shipping', 'billing', 'options', 'device_category', 'accept_headers', 'user_agent', 'mpi_merchant_name', 'mpi_merchant_url', 'mpi_description', 'purchaseRecurringFrequency', 'purchaseRecurringExpiry', 'purchaseInstallments'];
...
sub performTransactionViaAlternatePaymentMethod {
    ...
    my $ordered_keys = ['paymentOrganisation', 'paymentMethod', 'paymentType', 'paymentRequestType', 'trans_id', 'amount', 'currency', 'options'];
    $self->_request('performTransactionViaAlternatePaymentMethod', $ordered_keys, $args);
}
